...
opts2.f3db = 0.7; opts2.fpLP = 1; opts2.fstLP = 1.5;
ampfiltHRTh = filterLpHp(ampfiltTh,fsDS,opts2); 
...
title('Th recumbent 0.9GHz','FontSize',sz)
...
title('Ab recumbent 0.9GHz','FontSize',sz)
